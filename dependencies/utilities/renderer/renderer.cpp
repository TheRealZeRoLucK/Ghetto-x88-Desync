...
unsigned long render::fonts::gui_font;
unsigned long render::fonts::watermark_font;

void render::initialize() {
	render::fonts::gui_font = interfaces::surface->font_create();
	render::fonts::watermark_font = interfaces::surface->font_create();

	interfaces::surface->set_font_glyph(render::fonts::gui_font, "Verdana", 12, 500, 0, 0, font_flags::fontflag_outline);
