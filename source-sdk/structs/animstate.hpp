...
public:
	...
	float eye_yaw; //0x78
	float pitch; //0x7C
	float min_pitch; // 0x033C // no idea how they get this shit
	...
	void set_smooth_height_valid(bool value) {
		*reinterpret_cast<float*>(reinterpret_cast<uintptr_t>(this) + 0x328) = value;
	}
};
